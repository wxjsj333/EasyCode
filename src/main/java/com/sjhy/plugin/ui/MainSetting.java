    ...
    public MainSetting() {
        ...
        importBtn.addActionListener(e -> {
            ...
            try {
                ...
                coverConfig(jsonNode, StrState.SERVICE_MODULE, ServiceModuleGroup.class, settings.getServiceModuleGroupMap());
        ...
        exportBtn.addActionListener(e -> {
            ...
            dialogBuilder.addActionDescriptor(dialogWrapper -> new AbstractAction("OK") {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (!MainSetting.this.isSelected(typeMapperPanel, serviceModulePanel, templatePanel, columnConfigPanel, globalConfigPanel)) {
