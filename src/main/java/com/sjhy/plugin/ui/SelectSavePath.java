...
public class SelectSavePath extends JDialog {
  ...
  private void init() {
    ...
    allCheckBox.addActionListener(
        e -> checkBoxList.forEach(jCheckBox -> jCheckBox.setSelected(allCheckBox.isSelected())));
    ...
    pathChooseButton.addActionListener(e -> {
      ...
      VirtualFile virtualFile = FileChooser
          .chooseFile(FileChooserDescriptorFactory.createSingleFolderDescriptor(), project, path);
      if (virtualFile != null) {
